Creation of a application utilizing a MySQL DB and Webapp with Nodereact and NGINX.  This is a simple application developed by Nutanix to show what is possible.
